...
public class LimitlessButtonWidget extends ButtonWidget {
    ...
    public void renderWidget(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawTexture(RenderLayer::getGuiTextured, texture, this.getX() + 3, this.getY(), this.width - 6, 3, 3, 0, 1, 3, 200, 20);
        context.drawTexture(RenderLayer::getGuiTextured, texture, this.getX(), this.getY() + 3, 3, this.height - 6, 0, 3, 3, 1, 200, 20);
        context.drawTexture(RenderLayer::getGuiTextured, texture, this.getX() + 3, this.getY() + this.height - 3, this.width - 6, 3, 3, 20 - 3, 1, 3, 200, 20);
        context.drawTexture(RenderLayer::getGuiTextured, texture, this.getX() + this.width - 3, this.getY() + 3, 3, this.height - 6, 200 - 3, 3, 3, 1, 200, 20);
